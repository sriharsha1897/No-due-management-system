...
<div class="icon-bar">
  <a class="active" href="student_other_due.jsp"><i class="fa fa-home"></i></a> 
  <h3 class="b"><b>Other_Dues</b></h3>
...
<% 
			...
			try
			{
				...
				st=con.prepareStatement("select * from other_due where usn=?");
				st.setString(1,usn);
  ...
  <th><b>Student's Other Dues:</b></th>
   <tr>
    ...
    <th> Paid </th>
				...
				<p><h2>Student has <%=i-j%> Dues Pending</h2></p>
				</div>
				<% } else if(i==0){ %>
				<div class="primary-btn" align="left">
