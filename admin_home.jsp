  ...
  %>
	...
	<div align="center">
		<ul class="nav nav-tabs nav-justified">
		  <li role="presentation" class="active"><a href="admin_home.jsp">Mess Due</a></li>
		  <li role="presentation"><a href="office_dues.jsp">Office Due</a></li>
		  <li role="presentation"><a href="library_dues.jsp">Library Due</a></li>
		  <li role="presentation"><a href="other_dues.jsp">Other Due</a></li>
		</ul>
	</div>
	<!--Nav Ends-->
	<!--Body Starts-->
	...
	<div style="margin-top:5%">
		...
		<form class="form-horizontal" action="mess_due.jsp" method="post">
		...
		<div align="center">
			<h2>Mess Dues.</h2>
			<form class="form-inline" action="admin_mess_display.jsp" method="get">
				<div class="form-group">
