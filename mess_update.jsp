...
<div class="icon-bar">
  ...
  <h3 class="b"><b>Mess_Dues_Update</b></h3>
...
<% 
			...
			try
			{
				...
				st=con.prepareStatement("update mess_due set paid='1' where usn=?");
				st.setString(1,usn);
...
<p> <input type="button" onclick="window.location.href ='admin_u_home.jsp';" value=" Try Again "/>
<input type="button" onclick="window.location.href ='admin_hom.jsp';" value="Home"/></p></div></center>
<% } else {%><center>
<div class="primary-btn" align="center">
