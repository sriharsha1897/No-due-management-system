...
PreparedStatement ps=con.prepareStatement("insert into office_due values(?,?,?,?,?)");
ps.setString(1,usn);
ps.setInt(2,amount);
ps.setString(3,reason);
ps.setInt(4,0);
ps.setString(5, "Office_Due");
...
<p><input type="button" onclick="window.location.href ='index.html';" value="Home"/></p>
 <%} %>
<p> <input type="button" onclick="window.location.href ='office_dues.jsp';" value="Try_Again"/>
<p> <input type="button" onclick="window.location.href ='index.html';" value="Home"/></p>
</body>
</html>