  ...
  %>
	...
	<div align="center">
		<ul class="nav nav-tabs nav-justified">
		  <li role="presentation" class="active"><a href="admin_u_home.jsp">Mess Due Update</a></li>
	...
	<!--Body Starts-->
		<br><br><br><br>
		<div align="center">
			<h2>Mess Dues Update:</h2>
			<form class="form-inline" action="mess_update.jsp" method="post">
