...
<body>
<div class="icon-bar">
  <a class="active" href="admin_u_libdue.jsp"><i class="fa fa-home"></i></a> 
  <h3 class="b"><b>Library_Dues_update</b></h3>
...
<% 
			...
			try
			{
				...
				st=con.prepareStatement("update library_due set paid='1' where usn=?");
				st.setString(1,usn);
...
<p> <input type="button" onclick="window.location.href ='admin_u_libdue.jsp';" value=" Try Again "/>
