  ...
  %>
	...
	<div align="center">
		<ul class="nav nav-tabs nav-justified">
		  ...
		  <li role="presentation"class="active"><a href="library_dues.jsp">Library Due</a></li>
		  <li role="presentation"><a href="other_dues.jsp">Other Due</a></li></ul>
	</div>
	<!--Nav Ends-->
	<!--Body Starts-->
	...
	<div style="margin-top:5%">
		<h2 align="center">Add Library Due</h2>
		<form class="form-horizontal" action="library_due.jsp" method="post">
		...
		<div align="center">
			<h2>Library Dues.</h2>
			<form class="form-inline" action="admin_library_display.jsp" method="get">
				<div class="form-group">
