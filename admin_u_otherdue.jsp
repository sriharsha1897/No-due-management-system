  ...
  %>
	...
	<div align="center">
		<ul class="nav nav-tabs nav-justified">
		  ...
		  <li role="presentation" class="active"><a href="admin_u_otherdue.jsp">Other Due Update</a></li>
		</ul>
	</div>
	<!--Nav Ends-->
	<!--Body Starts-->
		<br><br><br><br>
		<div align="center">
			<h2>Other Dues Update:</h2>
			<form class="form-inline" action="other_update.jsp" method="post">
