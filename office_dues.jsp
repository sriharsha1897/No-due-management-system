  ...
  %>
	...
	<div align="center">
		<ul class="nav nav-tabs nav-justified">
		  ...
		  <li role="presentation" class="active"><a href="office_dues.jsp">Office Due</a></li>
	...
	<div style="margin-top:5%">
		<h2 align="center">Add Office Due</h2>
		<form class="form-horizontal" action="office_due.jsp" method="post">
		...
		<div align="center">
			<h2>Office Dues.</h2>
			<form class="form-inline" action="admin_office_display.jsp" method="get">
				<div class="form-group">
