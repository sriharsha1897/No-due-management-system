...
<body>
<div class="icon-bar">
  <a class="active" href="admin_u_otherdue.jsp"><i class="fa fa-home"></i></a> 
...
<% 
			...
			try
			{
				...
				st=con.prepareStatement("update other_due set paid='1' where usn=?");
				st.setString(1,usn);
...
<p> <input type="button" onclick="window.location.href ='admin_u_otherdue.jsp';" value=" Try Again "/>
