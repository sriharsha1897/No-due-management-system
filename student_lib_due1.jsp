  ...
  %>
	...
	<div align="center">
		<ul class="nav nav-tabs nav-justified">
		  ...
		  <li role="presentation"class="active"><a href="student_lib_due1.jsp">Library Due</a></li>
		  <li role="presentation"><a href="student_other_due1.jsp">Other Due</a></li>
		</ul>
	</div>
	<!--Nav Ends-->
	<!--Body Starts-->
		...
		<div align="center">
			<h2>Library Dues.</h2>
			<form class="form-inline" action="admin_library_display.jsp" method="post">
