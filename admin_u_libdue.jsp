  ...
  %>
	...
	<div align="center">
		<ul class="nav nav-tabs nav-justified">
		  ...
		  <li role="presentation"><a href="admin_u_offdue.jsp">Office Due Update</a></li>
		  <li role="presentation" class="active"><a href="admin_u_libdue.jsp">Library Due Update</a></li>
	...
	<!--Body Starts-->
		<br><br><br><br>
		<div align="center">
			<h2>Library Dues Update:</h2>
			<form class="form-inline" action="lib_update.jsp" method="post">
